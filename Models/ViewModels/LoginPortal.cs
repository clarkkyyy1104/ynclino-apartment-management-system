namespace YnclinoApartmentManagementSystem.Models.ViewModels
{
    ...
    // staff account typed into the tenant page is turned away with a link to the
    // right page instead of being let in.
    public sealed class LoginPortal
    {
        ...
        private LoginPortal(string action, string role, string audience, string title)
        {
            Action = action;
            Role = role;
            Audience = audience;
        ...
        public static readonly LoginPortal Tenant =
            new("Login", "Tenant", "tenant", "Tenant Sign In");

        public static readonly LoginPortal Maintenance =
            new("MaintenanceLogin", "Maintenance", "maintenance staff", "Maintenance Sign In");

        public static readonly LoginPortal Admin =
            new("AdminLogin", "Admin", "administrator", "Administrator Sign In");
